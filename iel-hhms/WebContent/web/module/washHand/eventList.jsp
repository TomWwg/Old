...
<body onload="prettyPrint();">
			...
			<div class="main-wrap"
				...
				<div class="fluid filterForm" style="height: 130px">
					<form id="filterForm" action="" method="post"
						...
						<input type="hidden" id=jobTypeInput name="jobType" value='<s:property value="queryEntity.str3"/>' />
						...
						<ul class="formRow" style="padding: 0px">
							...
							<li class="control-group auto-by-filter"><label
							  ...
							  <div class="controls">
							    <select id ="jobType" multiple="multiple" onchange="jobTypeSelect()">
							...
							<%-- <li class="control-group auto-by-filter"><label
							  ...
							  <div class="controls">
								...
								<s:select id='rfidStatus' list='rfidStatusMap'
				                 	listKey='key' listValue='value' onchange="rfidStatusSelect()" multiple="multiple">
				              </s:select>
								</div></li> --%>
	...
	<script type="text/javascript" src="js/historyEventList.js"></script>
