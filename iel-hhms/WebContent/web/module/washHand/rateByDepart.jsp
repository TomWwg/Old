...
<body onload="prettyPrint();">
	...
	<div class="wrapper" style="height: 100%">
		...
		<div class="fluid filterForm">
			<form id="filterForm" action=""
				...
				<input type="hidden" id="departInput" name="queryEntity.str1" value='<s:property value="queryEntity.str1"/>'/>
				<ul class="formRow" style="padding: 0px;position: fixed;">
				...
				<div class=btn-set style="position: fixed;">
		...
		<!-- 数据列表  -->
		<div id="chart_combo" style="height: 48%; " position="fixed"></div>
		<!-- <div class="datatable" style="height: 38%;">
			<table id="table">
			</table>
		</div> -->
		<div style="text-align:right;margin-right:20px;margin-bottom:5px;margin-top:8px">
			<div class=btn-set >
				<a class="buttonM bBlue" 
	...
	<script type="text/javascript" src="js/rateByDepart.js"></script>
</body>
</html>