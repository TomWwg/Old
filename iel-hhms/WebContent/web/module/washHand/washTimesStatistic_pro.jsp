...
<body onload="prettyPrint();">
				...
				<div class="statisticFrame" style="padding-left:20px;border-style: solid; border-width: 2px 0px 0px 0px; border-color: #aaaaaa;">
					<ul class="formRow" style="padding: 0px">
						<li class="control-group auto-by-filter">
							<label>本次统计的结果:<span class="error_info" id="error_info" >(您预设的值'每次出液预估'或'每瓶预设含量'可能有误)</span><span class="error_info" id="select_info" >&nbsp;&nbsp;请您选择科室查看洗手次数信息</span></label>
						</li>
						<li class="control-group auto-by-filter">
						
							<label>在所选时间段内，部门内共洗手:&nbsp;&nbsp;&nbsp;<span class="statis_result" id="statis_result_total_times">100</span>&nbsp;&nbsp;次    ;</label>
				
							&nbsp;&nbsp;&nbsp;<label >共出液约:&nbsp;&nbsp;&nbsp;<span class="statis_result" id="statis_result_per_out">2000</span>&nbsp;&nbsp;mL ;</label>
							
							&nbsp;&nbsp;&nbsp;<label >合计约:&nbsp;&nbsp;&nbsp;<span class="statis_result" id="statis_result_total_bottle">&nbsp;&nbsp;&nbsp;20</span>&nbsp;&nbsp;瓶     ;</label>
	...
	<script type="text/javascript" src="js/washTimesStatistics_pro.js"></script>
</body>
</html>
