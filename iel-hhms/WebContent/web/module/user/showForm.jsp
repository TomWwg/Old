...
function resetPassword(){
	jConfirm('确定要重置密码吗？','提示',function(r){
		if(r){
			$("#password").val("8ddcff3a80f4189ca1c9d4d902c3c909");
			var userId=$("#id").val();
			//console.log(userId);
			$.ajax({
				url:'resetPassword.action?entity.id='+userId,
				datatype:'text',
				success:function(data){
					if(data=="true"){
						jAlert("密码重置成功,重置后的密码为:88888888", '提示', 'attention');
					}else{
						jAlert("密码重置失败", '提示', 'attention');
					}
				}
			})
		}
...
<body onload="prettyPrint();">
	<div class="pageContent">
		<form id="showForm" action="" method="post" class="form-horizontal form-input">
			...
			<input type="hidden" id=password name="entity.password"
				value='<s:property value="entity.password"/>'>
			...
			<div class="pageContent">
				<fieldset class="noLegend">
					<div class="control-group input">
						...
						<div class="controls">
							<input id="name" name="entity.name" class='auto-input' type='text' readonly="readonly"
					...
					<!-- <div   class="control-group input">
						...
						<div class="controls">
							<input id="password" name="entity.password"
								class="auto-input valid" type="password" 
								vtype="minLength,maxLength" minlength="5"
								maxlength="13">
						</div>
					</div> -->
					...
					<!-- <div class="control-group input">
						...
						<div class="controls">
							<input id="passwordCheck" name="passwordCheck"
								class="auto-input valid" type="password"  vtype="equalToTag"
								 equalToTag="#password" />
						</div>
					</div> -->
					<div class="control-group input">
						<button class="controls" onclick="resetPassword()">点击重置密码</button>
					</div>
