	...
	<div class="wrapper" style="padding: 0px;">
		<form id="groupTreeForm" action="saveGroupTree.action" method="post"
			...
			<div class="control-group" style="margin-top: 20px;display:none;">
				...
				<div class="controls" style='position: relative' >
					 <select name="groupTree.departLevel" style="width: 232px; height:26px">
			        	<option value='${dl.departLevel}' selected="selected">${dl.departLevelName}</option>
			        	<option value="0">全院科室</option>
			        	<option value="1">当前科室</option>
		         	</select>
				</div>
			</div>
			</s:if>
